...
// 2. Comprehensive State-to-LGA Database Map
export const NIGERIA_LGA_MAP: Record<NigeriaStateEnum, string[]> = {
  [NigeriaStateEnum.ABIA]: [
  ...
  [NigeriaStateEnum.ADAMAWA]: [
    "Demsa", "Fufure", "Ganye", "Gayuk", "Gombi", "Grei", "Hong", "Jada", "Lamurde", 
    "Madagali", "Maiha", "Mayo Belwa", "Michika", "Mubi North", "Mubi South", 
    "Numan", "Shelleng", "Song", "Toungo", "Yola North", "Yola South"
  ],
  [NigeriaStateEnum.AKWA_IBOM]: [
  ...
  [NigeriaStateEnum.CROSS_RIVER]: [
    "Abi", "Akamkpa", "Akpabuyo", "Bakassi", "Bekwarya", "Biase", "Boki", 
    "Calabar Municipal", "Calabar South", "Etung", "Ikom", "Obanliku", 
    "Obubra", "Obudu", "Odukpani", "Ogoja", "Yakuur", "Yala"
  ],
  [NigeriaStateEnum.DELTA]: [
  ...
  [NigeriaStateEnum.IMO]: [
    ...
    "Oru West", "Owerri Municipal", "Owerri North", "Owerri South", "Nkwerre"
  ],
  [NigeriaStateEnum.JIGAWA]: [
    "Auyo", "Babura", "Biriniwa", "Birnin Kudu", "Buji", "Dutse", "Gagarawa", 
    "Garki", "Gumel", "Guri", "Gwaram", "Gwiwa", "Hadejia", "Jahun", "Kafur", 
    "Kaugama", "Kazaure", "Kiri Kasama", "Guri", "Maigatari", "Malam Madori", 
    "Miga", "Ringim", "Roni", "Sule Tankarkar", "Taura", "Yankwashi"
  ],
  [NigeriaStateEnum.KADUNA]: [
    "Birnin Gwari", "Chikun", "Giwa", "Kajuru", "Igabi", "Ikara", "Jaba", 
    "Jema'a", "Kachia", "Kaduna North", "Kaduna South", "Kagarko", "Kauru", 
  ...
  [NigeriaStateEnum.KATSINA]: [
    "Bakori", "Batagarawa", "Batsari", "Baure", "Bindawa", "Cheranchi", 
