...
function ProfileContent({ profile }: { profile: PersonalData | null }) {
  ...
  // TODO: Replace with dynamic field e.g., profile?.is_verified ?? false
    ...
    <section className="w-full flex flex-col gap-6 p-1 h-full min-h-screen">
      ...
      <div className="w-full flex flex-col sm:flex-row justify-between items-start gap-4 sm:items-center">
        ...
        <button 
          ...
          } px-5 py-2.5 rounded-xl text-white text-xs font-bold flex gap-2 items-center shadow-md active:scale-95 transition-all cursor-pointer`}
        >
          {isEdit ? (
            <>
