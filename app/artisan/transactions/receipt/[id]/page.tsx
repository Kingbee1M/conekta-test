...
export default function ReceiptPage() {
  ...
  // app/artisan/transactions/receipt/[id]/page.tsx
...
const handleDownloadPdf = async () => {
  ...
  try {
    // Included /artisan in the path to match app/artisan/transactions/receipt/pdf/route.ts
    const response = await fetch(`/artisan/transactions/receipt/pdf?id=${receipt.reference}`);
