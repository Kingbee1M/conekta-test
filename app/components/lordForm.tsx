...
export default function TenantForm({ 
    ...
    return (
        ...
        <div className="w-full h-full bg-white rounded-[calc(1rem-2px)] flex flex-col justify-center items-center gap-2 py-8 px-6 relative z-20">
            ...
            <button onClick={onSubmit} className="w-full bg-[#2171FF] text-white p-3 rounded-lg font-semibold hover:bg-[white] hover:text-[#2171FF] border-[0.5px] hover:border-[#2171FF] transition-colors cursor-pointer">
                Create Account
            </button>
            ...
            <div className="flex justify-evenly md:justify-between w-full my-3">
                ...
                <p className="text-sm">
                    Already have an account? <Link href='/log-in' className="font-semibold text-[#2171FF]">Sign in</Link>
                </p>
