...
export default function TenantForm({ 
    ...
    return (
        ...
        <div className="w-full h-full bg-white rounded-[calc(1rem-2px)] flex flex-col justify-center items-center gap-2 py-8 px-6 relative z-20">
            ...
            <button onClick={onSubmit} className="w-full bg-[#A93FFF] text-white p-3 rounded-lg font-semibold hover:bg-[white] hover:text-[#A93FFF] border-[0.5px] hover:border-[#A93FFF] transition-colors cursor-pointer">
                Create Account
            </button>
            ...
            <div className="flex justify-evenly md:justify-between w-full my-3">
                ...
                <p className="text-sm">
                    Already have an account? <Link href='/log-in' className="font-semibold text-[#A93FFF]">Sign in</Link>
                </p>
