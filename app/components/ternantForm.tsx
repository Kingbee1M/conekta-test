    ...
    return (
        ...
        <div className="w-full h-full bg-white rounded-[calc(1rem-2px)] flex flex-col justify-center items-center gap-4 py-8 px-6 relative z-20">
            ...
            <div className="outerDiv">
                ...
                <div className="inputDiv">
                    <FiPhone/>
                    <input className="inputTag" type="password" placeholder="+234 800 000 0000" value={password} onChange={(e) => setPassword(e.target.value)} />
                </div>
            ...
            <button onClick={onSubmit} className="w-full bg-[#00AC72] text-white p-3 rounded-lg font-semibold hover:bg-[white] hover:text-[#008f5d] hover:border-[0.5px] hover:border-[#008f5d] transition-colors cursor-pointer">
                Create Account
            </button>
            ...
            <p className="text-sm">
                Already have an account? <span className="font-semibold text-primary-green">Sign in</span>
            </p>
