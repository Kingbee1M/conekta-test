...
export default function TenantForm({
    ...
    return (
        ...
        >
            <div className="absolute inset-x-0 -bottom-full h-full bg-[#00AC72] z-10 transition-all duration-700 ease-in-out group-hover:bottom-0" />
            ...
            <div className="w-full h-full bg-white rounded-[calc(1rem-2px)] flex flex-col justify-center items-center gap-4 py-8 px-6 relative z-20">
                ...
                <button 
                    type="submit" 
                    disabled={isLoading}
                    className="w-full bg-[#00AC72] text-white p-3 rounded-lg font-semibold hover:bg-white hover:text-[#008f5d] border-[0.5px] hover:border-[#008f5d] transition-colors cursor-pointer flex justify-center items-center gap-2"
                >
                    {isLoading ? (
                        <>
