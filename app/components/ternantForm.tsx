...
export default function TenantForm({ 
    ...
    return (
        ...
        <div className="w-full h-full bg-white rounded-[calc(1rem-2px)] flex flex-col justify-center items-center gap-4 py-8 px-6 relative z-20">
            ...
            <button onClick={onSubmit} className="w-full bg-[#00AC72] text-white p-3 rounded-lg font-semibold hover:bg-[white] hover:text-[#008f5d] border-[0.5px] hover:border-[#008f5d] transition-colors cursor-pointer">
                Create Account
            </button>
