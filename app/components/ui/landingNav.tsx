    ...
    >
      <div className="w-full flex items-center justify-between px-5 py-2.5 bg-slate-100/80 backdrop-blur-md border border-slate-200/80 rounded-full shadow-sm transition-all duration-300">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link
            href="/sign-up"
            className="flex items-center gap-2 px-5 py-2 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold uppercase tracking-wider shadow-md transition-all active:scale-95"
          >
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <Link
              href="/sign-up"
              onClick={() => setIsMobileMenuOpen(false)}
              className="w-full flex items-center justify-center gap-2 py-3 rounded-2xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold uppercase tracking-wider shadow-md transition-all"
            >
              <span>Get Started</span>
