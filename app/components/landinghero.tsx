...
export default function LandingHero() {
    ...
    return (
        <section className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen flex justify-center px-5 min-h-fit bg-linear-to-br from-[#ECFDF5] to-white pt-15 md:pt-30 overflow-x-clip">
            ...
            <div className='w-full max-w-520  flex flex-col lg:flex-row items-start justify-between gap-48 md:gap-0 py-10 md:py-5 md:px-6'>
            {/* Left Section */}
                <div className="w-full md:w-[55%] flex items-start flex-col gap-8 px-4 md:px-0">
                    ...
                    <p className="w-[95%] text-sm md:text-sms">Discover, rent, buy, invest, and manage properties with flexible payment options. From virtual tours to trusted artisans, everything you need for your housing journey.</p>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        textClass='text-white group-hover:text-[#257448] text-xs' />

                        <p className="text-xs md:text-sm text-[#8a8f8e]">Tell us your needs and let AI find your perfect home</p>
                ...
                <div className="w-full max-w-100  relative">
                    ...
                    <AnimatePresence mode="popLayout" initial={false}>
                        ...
                        className="w-full h-100 md:h-150 overflow-hidden"
                        >
                        <Image 
                            src={frames[index]} 
                            alt={`Frame ${index + 1}`}
